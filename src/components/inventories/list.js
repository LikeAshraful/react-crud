        ...
        <div className='container'>
            ...
            <div className='w-full '>
                ...
                <table className='w-full table-auto'>
                    ...
                    <tr>
                        <th className="w-1/12 max-w-[80px] border-l border-transparent py-4 px-3 text-lg font-medium text-white lg:py-7 lg:px-4"> Sl </th>
                        <th className="w-3/12 min-w-[160px] border-l border-transparent py-4 px-3 text-lg font-medium text-white lg:py-7 lg:px-4"> Name </th>
                        <th className="w-5/12 min-w-[160px] border-l border-transparent py-4 px-3 text-lg font-medium text-white lg:py-7 lg:px-4"> Description </th>
                        <th className="w-2/12 max-w-[160px] border-l border-transparent py-4 px-3 text-lg font-medium text-white lg:py-7 lg:px-4"> Action </th>
                    </tr>
                    </thead>
